 ...
 */
final class Version20231116150316 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE regon_data (id INT NOT NULL, regon VARCHAR(14) NOT NULL, nazwa VARCHAR(60) NOT NULL, wojewodztwo VARCHAR(20) NOT NULL, powiat VARCHAR(30) NOT NULL, gmina VARCHAR(30) NOT NULL, miejscowosc VARCHAR(43) NOT NULL, kod_pocztowy VARCHAR(6) NOT NULL, ulica VARCHAR(40) NOT NULL, typ VARCHAR(2) NOT NULL, silos_id VARCHAR(1) NOT NULL, PRIMARY KEY(id))');
